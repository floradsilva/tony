		...
		?><div id="wcsatt_data" class="panel woocommerce_options_panel wc-metaboxes-wrapper <?php echo empty( $subscription_schemes ) ? 'planless onboarding' : ''; ?>">
			<div class="options_group general_scheme_options"><?php
				...
				woocommerce_wp_checkbox( array(
					...
					'label'       => __( 'One-off selling', 'woocommerce-all-products-for-subscriptions' ),
					'value'       => 'yes' === $product_object->get_meta( '_wcsatt_force_subscription', true ) ? 'no' : 'yes',
					'desc_tip'    => true,
					'description' => __( 'Disable this option to prevent customers from purchasing this product one-off. Applicable when at least one Subscription Plan has been added below.', 'woocommerce-all-products-for-subscriptions' )
				) );
				...
				woocommerce_wp_select( array(
					...
					'label'         => __( 'Default option', 'woocommerce-all-products-for-subscriptions' ),
					'description'   => '',
					'options'       => array(
						'one-time'     => __( 'One-off', 'woocommerce-all-products-for-subscriptions' ),
						'subscription' => __( 'Subscription', 'woocommerce-all-products-for-subscriptions' ),
					)
				) );
				...
				woocommerce_wp_textarea_input( array(
					...
					'label'       => __( 'Options heading', 'woocommerce-all-products-for-subscriptions' ),
					'description' => __( 'Custom html/text to display above the available Subscription Plans. Applicable when at least one Subscription Plan has been added below.', 'woocommerce-all-products-for-subscriptions' ),
					'placeholder' => __( 'Choose a subscription plan:', 'woocommerce-all-products-for-subscriptions' ),
					'desc_tip'    => true
				) );
				...
				if ( isset( $_POST[ '_wcsatt_onboarding' ] ) ) {
					...
					// Clear onboarding "welcome" notice.
	 				...
	 				if ( ! empty( $schemes ) ) {
	 					...
	 					WCS_ATT_Admin_Notices::add_cart_plans_onboarding_notice();
	 				}
	 			}
			}
