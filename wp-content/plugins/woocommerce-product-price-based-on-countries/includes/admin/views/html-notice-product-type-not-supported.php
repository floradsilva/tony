...
?>
<p style="display:none;border-left-color:#ffb900;position:relative;" class="notice-pbc wc-price-based-country-upgrade-notice wc-pbc-show-if-<?php echo esc_attr( $class ); ?> product-type-<?php echo esc_attr( $value ); ?>">
