...
<div class="notice notice-info notice-pbc pbc-is-dismissible">
	...
	<?php
		...
		printf( esc_html( __( 'Hi! Are you using %1$sGerman Market%2$s plugin? That\'s great! %1$sPrice Based on Country Pro%2$s supports the German Market plugin. %3$sRead more%4$s.', 'wc-price-based-country' ) ), '<strong>', '</strong>', '<a href="https://www.pricebasedcountry.com/2018/12/10/compatible-with-german-market-by-marketpress/?utm_source=german-market&utm_medium=banner&utm_campaign=Get_Pro" target="_blank" rel="noopener noreferrer">', '</a>' );
	?>
	</p>
</div>
