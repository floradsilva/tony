...
<div class="wrap woocommerce automatewoo-page automatewoo-page--licenses">
    ...
    <div class="automatewoo-content">
        ...
        <p><?php printf(
				  __( 'In order to receive plugin updates for AutomateWoo extensions you must enter a license key. If you do not have a license key please see <a href="%s" target="_blank">details & pricing</a>. If your license has expired you may still use it to activate this domain but you will not be able to receive updates.', 'automatewoo' ),
